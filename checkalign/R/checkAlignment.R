...
#'
#' @examples
checkAlignment <- function(x, show = "both",
...
#' @export
checkAlignment.ggplot <- function(x, show = "both",
                                  include=".", exclude=NULL,
                                  separateText = TRUE, rounding=4) {
  print(x)
  grid.force()
  checkAndDraw(show, include, exclude, separateText, rounding)
}

#' @export
checkAlignment.trellis <- function(x, show = "both",
                                   include=".", exclude=NULL,
                                   separateText = TRUE, rounding=4) {
  print(x)
  checkAndDraw(show, include, exclude, separateText, rounding)
...
#' @export
checkAlignment.function <- function(x, show = "both",
                                    include=".", exclude=NULL,
                                    separateText = TRUE, rounding=4) {
  grid.newpage()
...
#' @export
checkAlignment.recordedplot <- function(x, show = "both",
                                        include=".", exclude=NULL,
                                        separateText = TRUE, rounding=4) {
  replayPlot(x)
