...
#' @importFrom drawGrob
#' @examples
drawAlignment <- function(listing, info, show = "both",
  ...
  if(show == "aligned" | show == "both") {
    ...
    # }
    res <- drawMatch(info$matchInfo, info$grobInfo, item, rounding)
    table
  }
}
